...
public class DalItemDiscount extends DalObject<DalItemDiscount> {
    ...
    public DalItemDiscount() throws SQLException {
        super(ItemDiscountDalController.getInstance());
    }

    public DalItemDiscount(String discountDate, String supplierID) throws SQLException {
        super(ItemDiscountDalController.getInstance());
        this.discountDate = discountDate;
        this.supplierID = supplierID;
    }

    public DalItemDiscount(String discountDate, String supplierID, int itemID) throws SQLException {
        super(ItemDiscountDalController.getInstance());
        this.discountDate = discountDate;
        this.supplierID = supplierID;
        this.itemID = itemID;
    ...
    public DalItemDiscount(String discountDate, String supplierID, int itemID, double discount, int itemCount) throws SQLException {
        super(ItemDiscountDalController.getInstance());
        this.discountDate = discountDate;
        this.supplierID = supplierID;
        this.itemID = itemID;
