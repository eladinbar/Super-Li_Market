...
public class DalCategorySale extends DalObject<DalCategorySale> {
    ...
    public DalCategorySale() throws SQLException {
        super(CategorySaleDalController.getInstance());
    }

    public DalCategorySale(String name) throws SQLException {
        super(CategorySaleDalController.getInstance());
        this.name = name;
    }

    public DalCategorySale(String name, double discount, String startSaleDate, String endSaleDate, String categoryName) throws SQLException {
        super(CategorySaleDalController.getInstance());
        this.name = name;
