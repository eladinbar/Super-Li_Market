...
public class DalSupplierContactMembers extends DalObject$<DalSupplierContactMembers> {
    ...
    public DalSupplierContactMembers(int supplierId, int personId) throws SQLException {
        super(SupplierContactMembersDalController.getInstance());
        this.supplierId = supplierId;
        this.personId = personId;
    }

    public DalSupplierContactMembers(int supplierId) throws SQLException {
        super(SupplierContactMembersDalController.getInstance());
        this.supplierId = supplierId;
    }
