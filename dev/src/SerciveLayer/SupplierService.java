...
public class SupplierService {
    ...
    public ResponseT<Supplier> addSupplier(String firstName, String lastName, String email, String id, String phone, int companyNumber, boolean isPernamentDays, boolean selfDelivery, String payment) {
        ...
        try {
            toReturn = new ResponseT<>(new SerciveLayer.objects.Supplier(sp.addSupplier(firstName, lastName, email, id, phone, companyNumber, isPernamentDays, selfDelivery, payment)));
        } catch (Exception e) {
    ...
    public ResponseT<Supplier> getSupplier(String id) {
        ResponseT<Supplier> toReturn;
        try {
            toReturn = new ResponseT<>(new SerciveLayer.objects.Supplier(sp.getSupplier(id)));
        } catch (Exception e) {
            toReturn = new ResponseT<>(e.getMessage());
        }
        return toReturn;
