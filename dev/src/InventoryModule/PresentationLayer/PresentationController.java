...
public class PresentationController implements Runnable {
    ...
    private void setupSystem() {
        ...
        //Guinness sale
        Calendar start = Calendar.getInstance();
        start.set(2021, Month.APRIL.getValue(),11);
        Calendar end = Calendar.getInstance();
        end.set(2021, Month.APRIL.getValue(),15);
        service.addItemSale("Guinness Sale",25285,0.2,start,end);

        //vannila milk sale
        Calendar start2 = Calendar.getInstance();
        start2.set(2021, Month.APRIL.getValue(),22);
        Calendar end2 = Calendar.getInstance();
        end2.set(2021, Month.APRIL.getValue(),27);
